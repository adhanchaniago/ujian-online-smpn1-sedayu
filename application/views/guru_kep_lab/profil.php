      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="'.base_url().'guru-kep-lab/data-guru-update" role="form" id="edit" method="post" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo base_url('guru-kep-lab/edit-profil/'.$row->username) ?>" class="btn btn-primary edit">Edit</a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
